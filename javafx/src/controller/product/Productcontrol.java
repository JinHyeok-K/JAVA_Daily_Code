...
public class Productcontrol implements Initializable {
    ...
    @FXML
    void search(ActionEvent event) {// 검색 버튼 눌렀을 때
    ...
    void show(String search) {
    	...
    	if (vbox.getChildren().isEmpty()== false) { // .isEmpty() : 해당 객체 내 비어있는지 확인 [vbox 내 비어있는지 ]
    		// vbox 내 객체가 비어있지 않으면
		...
		= ProductDao.productDao.list(Home.category,search);
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		show(null); // 화면을 처음 열렸을 때는 검색어를 null 넣어주기
	}
}

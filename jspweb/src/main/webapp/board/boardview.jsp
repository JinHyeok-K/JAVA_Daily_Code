...
<body>
 ...
 <!----------------------------------- 게시물 삭제/수정/목록 버튼 구역 ------------------------------------------------->		
		...
		%>
			<div class="col-md-2">
				<a href="board_delete?bno=<%=board.getBno()%>"> <button class="form-control">삭제</button> </a> <!--작성자와 로그인된 id가 동일하면 보이는 버튼  -->
			</div>	
			<div class="col-md-2">
				<a href="board_update.jsp?bno=<%=board.getBno()%>"> <button class="form-control">수정</button> </a> <!--작성자와 로그인된 id가 동일하면 보이는 버튼  -->
			</div>
		<%} %>
			<div class="col-md-2">

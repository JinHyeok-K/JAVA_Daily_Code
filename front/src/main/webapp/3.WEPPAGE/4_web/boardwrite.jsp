...
<body>
	...
	<div class="container">
		<h3 class="text-center">문의 글 쓰기</h3>
		
		<div class="titleline" > </div>
		<br><br>
		
		<form action="#" method="get"> <!--  폼 양식 [ 입력값을 전송 가능 ] -->
						<!-- action="java 컨트롤에게 전송 " -> 컨트롤 -> DB에게 전송 -->
			<div class= "row">
				<div class="col-md-3">
					작성자 : <input type="text" class="form-control" placeholder="작성자" maxlength="10">
				</div>
				<div class="col-md-3">
					비밀번호 :<input type="password" class="form-control" placeholder="비밀번호" maxlength="10">
				</div>			
			</div>
			...
			내용 : <textarea rows="15" cols="" class="form-control" placeholder="문의 내용을 작성해주세요" ></textarea>
			<div class="row">
				<div class="col-md-3">
					첨부파일 : <input type="file" class="form-control">	 <!-- 첨부파일 입력 상자 -->
				</div>
			</div>
			<div >

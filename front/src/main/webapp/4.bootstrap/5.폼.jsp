...
<body>
	<%@include file="1.설치.jsp" %>
		...
		<div class="container row"> <!--  class="클래스명1 클래스명2 클래스명3 " : 복수 가능 -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<img alt="" src="../백여우2.jpg" width="100%"> <!--  사진 크기 변경 -->
				</div>
				<div class="col-md-3">
					<img alt="" src="../백여우2.jpg" width="100%" style="border-radius: 100px;">
				</div>
				<div class="col-md-3">
					<img alt="" src="../백여우2.jpg" width="100%">
				</div>
				<div class="col-md-3">
					<img alt="" src="../백여우2.jpg" width="100%">
				</div>
